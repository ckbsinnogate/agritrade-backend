"""
Credit Systems Implementation using Django Shell
"""
...
if farmers.exists() and products.exists():
    credit_scenarios = [
        {
            'farmer': farmers[0],
            'product': products[0],
    ...
    print('   ⚠️ No farmers or products found - skipping credit transaction creation')
...
print('-' * 30)
print(f'Total Credit Gateways: {credit_gateways}')
print(f'Total Credit Transactions: {len(created_credit_transactions)}')
total_credit_value = sum(t.amount for t in created_credit_transactions) if created_credit_transactions else Decimal('0')
print(f'Total Credit Value: {total_credit_value} GHS')
print('✅ CREDIT SYSTEMS IMPLEMENTATION COMPLETE!')
